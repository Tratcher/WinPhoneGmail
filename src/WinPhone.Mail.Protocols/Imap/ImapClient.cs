...
namespace WinPhone.Mail.Protocols {
	...
	public class ImapClient : TextClient, IMailClient {
		...
		public ImapClient() { }
		public ImapClient(string host, string username, string password, AuthMethods method = AuthMethods.Login, int port = 143, bool secure = false, bool validateCertificate = true) {
